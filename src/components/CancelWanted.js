  ...
  constructor(props) {
    ...
    this.state = {
      query: new Query([
        ...
        { required: true, name: 'Reason for Cancellation', code: 'res', set: [], alpha: true, numeric: true, special: true, custom: null, min: 5, max: 150, input: '', placeholder: 'Alabi was confirmed.' },
